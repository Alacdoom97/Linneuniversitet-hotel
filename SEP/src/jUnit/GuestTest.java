...
public class GuestTest {
	...
	public void CreateGuest() {
		...
		Guest g2 = new Guest(2, "Burger King", "Pranav", "Patel", "Smultronvägen","hhahaha", "1997-11-25", true, false);
		Guest g3 = new Guest(3, "MAX", "Vikrant", "Mainali", "Blåbärsvägen","hhahaha", "1998-12-03", true, false);
